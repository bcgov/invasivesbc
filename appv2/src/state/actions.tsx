...
export const TOGGLE_PUBLIC_LAYER = 'TOGGLE_PUBLIC_LAYER';
export const SHOW_DEFAULT_PUBLIC_LAYERS = 'SHOW_DEFAULT_PUBLIC_LAYERS';
export const HIDE_DEFAULT_PUBLIC_LAYERS = 'HIDE_DEFAULT_PUBLIC_LAYERS';
