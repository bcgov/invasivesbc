...
MonitoringBiocontrolReleaseTerrestrialPlant.columns = [
  ...
  new TemplateColumnBuilder('Monitoring - Start', 'datetime').mustNotBeFuture().isRequired().build(),
  new TemplateColumnBuilder('Monitoring - End', 'datetime').mustNotBeFuture().isRequired().build(),
  ...
  new TemplateColumnBuilder('Monitoring - Invasive Plant', 'codeReference')
  ...
  new TemplateColumnBuilder('Monitoring - Agent Code', 'codeReference')
  ...
  new TemplateColumnBuilder('Monitoring - Actual - Agent Stage', 'codeReference')
    .referencesCode('biocontrol_agent_stage_code')
    .build(),
  new TemplateColumnBuilder('Monitoring - Actual - Quantity', 'numeric').build(),
  new TemplateColumnBuilder('Monitoring - Actual - Plant Position', 'codeReference')
    .referencesCode('plant_position_code')
    .build(),
  new TemplateColumnBuilder('Monitoring - Actual - Agent Location', 'codeReference')
    .referencesCode('location_agents_found_code')
    .build(),

  new TemplateColumnBuilder('Monitoring - Estimated - Agent Stage', 'codeReference')
    .referencesCode('biocontrol_agent_stage_code')
    .build(),
  new TemplateColumnBuilder('Monitoring - Estimated - Quantity', 'numeric').build(),
  new TemplateColumnBuilder('Monitoring - Estimated - Plant Position', 'codeReference')
    .referencesCode('plant_position_code')
    .build(),
  new TemplateColumnBuilder('Monitoring - Estimated - Agent Location', 'codeReference')
    .referencesCode('location_agents_found_code')
    .build(),

  new TemplateColumnBuilder('Monitoring - Monitoring Method', 'codeReference')
