...
export const updateUpdateRequestSQL = (
  ...
  return SQL`
    ...
    SET first_name           = ${newUpdateRequest.firstName ? newUpdateRequest.firstName : null},
...
export const createUpdateRequestSQL = (updateRequest): SQLStatement => {
  return SQL`
    INSERT INTO access_request (idir_account_name,
                                bceid_account_name,
                                first_name,
                                last_name,
                                primary_email,
                                ...
                                bceid_userid,
                                request_type)
    values (${updateRequest.idir ? updateRequest.idir : null},
...
export const approveUpdateRequestsSQL = (updateRequest): SQLStatement => {
  ...
  return SQL`
    ...
    set first_name=${updateRequest.first_name},
