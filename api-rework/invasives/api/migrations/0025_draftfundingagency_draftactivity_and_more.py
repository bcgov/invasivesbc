# Generated by Django 6.0 on 2026-06-29 21:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("computed_map_symbol", models.CharField(blank=True, max_length=128)),
                (
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["type", "date"], name="draft_activity_date_type_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="draftactivity",
            index=models.Index(
                fields=["subtype", "date"], name="draft_activity_date_sub_idx"
            ),
        ),
    ]
