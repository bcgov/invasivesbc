...
class AquaticPlantObservationDetailSerializer(serializers.ModelSerializer):
  ...
  def get_voucher_specimen(self, obj):
    ...
    try:
      voucher_specimen = AquaticVoucherSpecimen.objects.get(activity_id=activity_id, invasive_plant=invasive_plant)
...
class AquaticObservationSerializer(serializers.Serializer):
  adjacent_land_use = WaterbodyAdjacentLandUseSerializer(source="waterbodyadjacentlanduse_set", many=True)
  ...
  inflow_seasonal = WaterbodyInflowSeasonalSerializer(source="waterbodyinflowseasonal_set", many=True)
  outflow_permanent = WaterbodyOutflowPermanentSerializer(source="waterbodyoutflowpermanent_set", many=True)
  outflow_seasonal =  WaterbodyOutflowSeasonalSerializer(source="waterbodyoutflowseasonal_set", many=True)
