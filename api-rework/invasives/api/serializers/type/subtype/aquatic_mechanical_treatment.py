...
class AquaticPlantTreatmentMechanicalSerializer(serializers.Serializer):
  mechanical_treatments = AquaticPlantMechanicalTreatmentSerializer(source="aquaticplantmechanicaltreatment_set", many=True)
  authorization_info = serializers.CharField(source="aquaticmechanicalauthorization.authorization_information")
