...
from api.models.activity.activity import Activity, ActivitySubtypes
...
class ActivityWriteSerializer(serializers.ModelSerializer):
    subtype_data = serializers.DictField()
    ...
    def _delegate_to_subtype(self, subtype):
        delegates = {
        ...
        return delegates.get(subtype, None)
    ...
    def create(self, validated_data):
        ...
        subtype_serializer = self._delegate_to_subtype(validated_data["subtype"])
        return instance
