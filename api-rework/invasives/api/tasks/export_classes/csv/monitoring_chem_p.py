...
from api.models.export.csv import MonitoringChemicalPlant


class MonitoringChemicalTreatmentPlantCsvRow(
    CsvTransformerBase[MonitoringChemicalPlant, TerrestrialTreatmentMonitoringEntry]
):
    csv_model = MonitoringChemicalPlant
