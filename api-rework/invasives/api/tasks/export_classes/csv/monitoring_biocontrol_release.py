...
from api.models.export.csv import MonitoringBiocontrolReleasePlant
from api.models.enums import YesNo
from django.db.models import Sum


class MonitoringBiocontrolReleasePlantCsvRow(
    CsvTransformerBase[
        MonitoringBiocontrolReleasePlant, TerrestrialBiocontrolDispersalMonitoringEntry
    ]
):
    csv_model = MonitoringBiocontrolReleasePlant
            ...
            rows.append(
                self.csv_model(
                    **common_fields,
                    ...
                    max_spread_distance_m=self.safe_attr(
                        spread, "max_spread_distance_m"
                    ),
                    max_spread_aspect_deg=self.safe_attr(
                        spread, "max_spread_aspect_deg"
                    ),
                )
            )
