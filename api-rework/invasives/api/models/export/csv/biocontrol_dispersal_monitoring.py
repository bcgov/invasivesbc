...
class MonitoringBiocontrolDispersal(BaseCsvExportModel):
    ...
    biocontrol_present = models.CharField(null=True, blank=True)
    biological_agent_presence = models.CharField(blank=True, null=True)
    monitoring_type = models.CharField(null=True, blank=True)
    ...
    monitoring_start_time = models.DateTimeField(null=True, blank=True)
    monitoring_stop_time = models.DateTimeField(null=True, blank=True)
    ...
    phenology_details_recorded = models.CharField(choices=YesNo, null=True, blank=True)
