...
class TreatmentChemicalPlantAquatic(BaseCsvExportModel):
    ...
    service_license = models.CharField(null=True, blank=True)
    ...
    treatment_notice_signs = models.CharField(null=True, blank=True)
    ...
    invasive_plant_percent_covered = models.FloatField(null=True, blank=True)
    tank_mix_used = models.CharField(choices=YesNo)
    chemical_application_method = models.CharField(null=True, blank=True)
    herbicide_type = models.CharField(null=True, blank=True)
    herbicide_name = models.CharField(null=True, blank=True)
    pesticide_use_permit = models.CharField(blank=True, null=True)
    calculation_type = models.CharField(null=True, blank=True)
