...
class TreatmentChemicalPlantAquatic(BaseCsvExportModel):
    ...
    service_license = models.CharField()
    ...
    invasive_plant_percent_covered = models.FloatField()
    tank_mix_used = models.CharField(choices=YesNo)
    chemical_application_method = models.CharField()
    herbicide_type = models.CharField()
    herbicide_name = models.CharField()
