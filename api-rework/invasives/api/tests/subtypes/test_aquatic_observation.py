...
class AquaticObservationTest(BaseActivitySubtypeTest):
    ...
    def test_submit_record(self):
        ...
        """
        create_return = self.submit_record(MINIMAL_AQUATIC_OBSERVATION).json()
        fetch_return = self.fetch(id=MINIMAL_AQUATIC_OBSERVATION["id"]).json()
    ...
    def test_update_record(self):
        ...
        """
        update_return = self.submit_record(UPDATED_AQUATIC_OBSERVATION).json()
        fetch_return = self.fetch(id=UPDATED_AQUATIC_OBSERVATION["id"]).json()
