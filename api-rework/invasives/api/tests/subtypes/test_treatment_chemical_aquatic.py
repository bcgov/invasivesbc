...
class AquaticChemicalTreatmentTest(BaseActivitySubtypeTest):
    ...
    def match_updated_subtype_details(self, record_in: dict, record_out: dict):
        ...
        self.assertEqual(
            form_context_in["pesticide_use_permit"],
            form_context_out["pesticide_use_permit"],
        )
        self.assertEqual(
        ...
        self.assertEqual(
            treatment_context_in["area_treated_sqm"],
            treatment_context_out["area_treated_sqm"],
        )
        self.assertEqual(
            treatment_context_in["dilution_percent"],
        ...
        for h_in, h_out in zip(
            ...
            if pac_number := h_in.get("application_rate", None):
                self.assertEqual(pac_number, h_out["application_rate"])
    ...
    def test_initial_draft_submission(self):
        ...
        """
        payload = EMPTY_CHEM_TREATMENT_AQUATIC
    ...
    def test_update_draft_submission(self):
        ...
        """
        payload = copy.deepcopy(UPDATED_CHEM_TREATMENT_AQUATIC)
        payload["form_status"] = "Draft"

        # Submit initial Draft
        res = self.draft_record(MINIMAL_CHEM_TREATMENT_AQUATIC)
    ...
    def test_submit_record(self):
        ...
        Expect:
            ...
            - Record is created in DB
        """
        payload = MINIMAL_CHEM_TREATMENT_AQUATIC
    ...
    def test_update_record(self):
        payload = UPDATED_CHEM_TREATMENT_AQUATIC
