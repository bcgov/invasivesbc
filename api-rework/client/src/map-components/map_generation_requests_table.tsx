...
interface MapRecord {
  ...
  raster: boolean
  updated: Date
  bounds: GeoJSON.GeoJSON | string
}

const MapGenerationRequestTable: React.FC<{setMap: (m: MapRecord) => void }> = ({ setMap }) => {
  const [requests, setRequests] = useState<MapRecord[]>([]);
...
export default MapGenerationRequestTable
