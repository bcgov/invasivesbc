...
import MigrationStatusView from 'activities/migration_status_view';
...
const ActivitiesDetail: React.FC = () => {
  ...
  return (
    <div className="activities-detail">
      ...
      <nav className={'tabs'}>
        <ul>
          <NavLink className={({ isActive }) => (isActive ? 'active' : 'inactive')} to={`/activities/${id}/legacy`}>
            Legacy Model
          </NavLink>
          <NavLink className={({ isActive }) => (isActive ? 'active' : 'inactive')} to={`/activities/${id}/pydantic`}>
            Pydantic Model
          </NavLink>
          <NavLink className={({ isActive }) => (isActive ? 'active' : 'inactive')} to={`/activities/${id}/django`}>
            Final Django Model
          </NavLink>
          <NavLink className={({ isActive }) => (isActive ? 'active' : 'inactive')} to={`/activities/${id}/ninja`}>
            Ninja Model
          </NavLink>
          <NavLink className={({ isActive }) => (isActive ? 'active' : 'inactive')} to={`/activities/${id}/migration`}>
            Migration Status
          </NavLink>
          <NavLink className={({ isActive }) => (isActive ? 'active' : 'inactive')} to={`/activities/${id}/form`}>
            View as Form
          </NavLink>
          <li>
            <a
      ...
      <Routes>
        ...
        <Route
          path="/migration"
          element={<MigrationStatusView migrationStatus={migrationStatus} rerunImport={rerunImport} />}
        />
        <Route
          path="/ninja"
          element={
