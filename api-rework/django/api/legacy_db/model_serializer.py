...
class LegacyActivityTypeData(BaseModel):
  ...
  linked_id: Optional[str] = Field(default=None)  # this can appear in other places too. which is the authority?
  legacy_iapp_id: Optional[str | int] = Field(default=None)  # Is this related to historical_iapp_site_id?
  copy_geometry: Optional[Literal['Yes', 'No']] = Field(
    default=None)  # this can appear in other places too. which is the authority?
  activity_persons: Optional[list[LegacyActivityPersons]] = Field(default=None)
  pre_treatment_observation: Optional[Literal["Yes", "No", "Unknown"]] = Field(default=None)
...
class LegacyActivityVoucherSpecimenInformation(BaseModel):
  ...
  voucher_verification_completed_by: Optional[LegacyActivityVoucherVerificationInformation] = Field(default=None)
...
class LegacyActivityTerrestrialPlants(BaseModel):
  ...
  voucher_specimen_collection_information: Optional[LegacyActivityVoucherSpecimenInformation] = Field(default=None)
...
class LegacyActivityTerrestrialPlantObservation(BaseModel):
  ...
  suitable_for_biocontrol_agent: Optional[Literal["Yes", "No", "Unknown"]] = Field(default=None)
...
class LegacyActivityMechanicalPlantTreatmentInformation(BaseModel):
  ...
  disposed_material: Optional[LegacyActivityMechanicalDisposedMaterial] = Field(default=None)
  ...
  def strip_empty(cls, values: dict) -> dict:
    if isinstance(values, dict):
      if isinstance(values.get("target_plant_heights"), list):
        values["target_plant_heights"] = [v for v in values["target_plant_heights"] if v != {}]
    return values
...
class LegacyBiocontrolCollectionInformation(BaseModel):
  ...
  historical_iapp_site_id: Optional[int | str] = Field(default=None)  # Is this related to legacy_iapp_id?
  ...
  actual_biological_agents: Optional[list[LegacyBiologicalAgentInformation]] = Field(default=None)
  estimated_biological_agents: Optional[list[LegacyBiologicalAgentInformation]] = Field(default=None)
...
class LegacyBiocontrolDispersionMonitoring(BaseModel):
  ...
  suitable_collection_site: Optional[Literal["Yes", "No", "Unknown"]] = Field(default=None)
  ...
  estimated_biological_agents: Optional[list[LegacyBiologicalAgentMonitoringInformation]] = Field(default=None)
  actual_biological_agents: Optional[list[LegacyBiologicalAgentMonitoringInformation]] = Field(default=None)
  num_of_sweeps: Optional[int] = Field(default=None)
  plant_count: Optional[int] = Field(default=None)
...
class LegacyActivitySubtypeData(BaseModel):
  ...
  def strip_empty(cls, values: dict) -> dict:
    if isinstance(values, dict):
      if isinstance(values.get("TerrestrialPlants"), list):
        values["TerrestrialPlants"] = [v for v in values["TerrestrialPlants"] if v != {}]

      # an element of the list is a list
      if isinstance(values.get("Well_Information"), list):
        flatten = lambda x: x[0] if isinstance(x, list) and x[0] is not None else x
        values["Well_Information"] = [flatten(v) for v in values["Well_Information"]]

      # it isn't a list but should be
      if isinstance(values.get("Monitoring_BiocontrolRelease_TerrestrialPlant_Information"), dict):
        values["Monitoring_BiocontrolRelease_TerrestrialPlant_Information"] = [values["Monitoring_BiocontrolRelease_TerrestrialPlant_Information"]]

    return values

  TerrestrialPlants: Optional[list[LegacyActivityTerrestrialPlants]] = Field(default=None)
  Observation_PlantTerrestrial_Information: Optional[LegacyActivityTerrestrialPlantObservation] = Field(default=None)
  ...
  Treatment_MechanicalPlant_Information: Optional[list[LegacyActivityMechanicalPlantTreatmentInformation]] = Field(
    default=None)
  Treatment_ChemicalPlant_Information: Optional[LegacyActivityChemicalPlantTreatmentInformation] = Field(default=None)
  Pest_Injury_Threshold_Determination: Optional[LegacyActivityPestInjuryThresholdDetermination] = Field(default=None)
  chemical_treatment_details: Optional[LegacyChemicalTreatmentDetails] = Field(default=None)
  Observation_PlantAquatic_Information: Optional[LegacyActivityAquaticPlantObservation] = Field(default=None)
  AquaticPlants: Optional[list[LegacyActivityAquaticPlants]] = Field(default=None)
  Monitoring_ChemicalTerrestrialAquaticPlant_Information: Optional[list[LegacyActivityChemicalMonitoring]] = Field(
    default=None)
  ...
  Biocontrol_Collection_Information: Optional[list[LegacyBiocontrolCollectionInformation]] = Field(default=None)
  Monitoring_BiocontrolDispersal_Information: Optional[list[LegacyBiocontrolDispersionMonitoring]] = Field(default=None)
  Biocontrol_Release_Information: Optional[list[LegacyBiocontrolReleaseInformation]] = Field(default=None)
  ...
  Monitoring_BiocontrolRelease_TerrestrialPlant_Information: Optional[
    list[LegacyBiocontrolReleaseTerrestrialPlantInformation]] = Field(default=None)
  ...
  Monitoring_MechanicalTerrestrialAquaticPlant_Information: Optional[
    list[LegacyMechanicalTerrestrialAquaticMonitoringInformation]] = Field(default=None)
  ...
  def sanitize(cls, values: dict) -> dict:
    ...
    if isinstance(values, dict):
      ...
      if isinstance(values.get("jurisdiction"), list):
        values["jurisdiction"] = [v for v in values["jurisdiction"] if v is not None]
