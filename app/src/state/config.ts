...
switch (CONFIGURATION_SOURCE) {
  ...
  case 'Provided':
    CONFIG = {
      ...
      KEYCLOAK_CLIENT_ID: 'inv',//CONFIGURATION_KEYCLOAK_CLIENT_ID,
      KEYCLOAK_REALM: 'banana',// CONFIGURATION_KEYCLOAK_REALM,
      KEYCLOAK_URL: 'http://localhost:8080',//CONFIGURATION_KEYCLOAK_URL,
      KEYCLOAK_ADAPTER: 'capacitor',//,CONFIGURATION_KEYCLOAK_ADAPTER,
