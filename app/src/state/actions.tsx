...
export const ACTIVITY_GET_SUGGESTED_BIOCONTROL_AGENTS_SUCCESS = 'ACTIVITY_GET_SUGGESTED_BIOCONTROL_AGENTS_SUCCESS';
...
export const MAP_CHOOSE_BASEMAP = 'MAP_CHOOSE_BASEMAP';
export const MAP_UPDATE_AVAILABLE_BASEMAPS = 'MAP_UPDATE_AVAILABLE_BASEMAPS';

export const MAP_TOGGLE_OVERLAY = 'MAP_TOGGLE_OVERLAY';
export const MAP_UPDATE_AVAILABLE_OVERLAYS = 'MAP_UPDATE_AVAILABLE_OVERLAYS';
