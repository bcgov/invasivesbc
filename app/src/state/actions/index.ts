...
export const TABS_SET_TAB_CONFIG_REQUEST = 'TABS_SET_TAB_CONFIG_REQUEST';
export const TABS_SET_TAB_CONFIG_SUCCESS = 'TABS_SET_TAB_CONFIG_SUCCESS';
export const TABS_SET_TAB_CONFIG_FAILURE = 'TABS_SET_TAB_CONFIG_FAILURE';
