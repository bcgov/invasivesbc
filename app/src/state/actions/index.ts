...
export const BATCH_ATTACH_FILE_REQUEST = 'BATCH_ATTACH_FILE_REQUEST';
export const BATCH_ATTACH_FILE_SUCCESS = 'BATCH_ATTACH_FILE_SUCCESS';
export const BATCH_ATTACH_FILE_ERROR = 'BATCH_ATTACH_FILE_ERROR';
