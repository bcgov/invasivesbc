...
export const ACTIVITY_GET_INITIAL_STATE_REQUEST = 'ACTIVITY_UPDATE_GEO_REQUEST';
export const ACTIVITY_GET_INITIAL_STATE_SUCCESS = 'ACTIVITY_UPDATE_GEO_SUCCESS';
export const ACTIVITY_GET_INITIAL_STATE_FAILURE = 'ACTIVITY_UPDATE_GEO_FAILURE';
