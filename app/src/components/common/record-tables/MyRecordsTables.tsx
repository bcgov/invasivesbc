...
import { activitesDefaultHeaders, IActivitiesTable, ActivitiesTable, AnimalActivitiesTable, ObservationsTable, TreatmentsTable, MonitoringTable, TransectsTable, BiocontrolTable } from './ActivityTables';
...
export const MyActivitiesTable: React.FC<IActivitiesTable> = (props) =>
  <ActivitiesTable
    created_by={useKeycloakWrapper().preferred_username}
    {...myRecordsTableDefaults}
    {...props}
  />
