...
const RecordTable = {
  ...
  properties: {
    ...
    tableSchemaType: { // might remove this, and use inheritance instead
      type: "array",
      description: "Array of schema names which will be used to auto-import matching header field definitions.  Only imports headers with ids matching fields in the given schemas"
    },
    actions: {
      title: "Actions",
    ...
    dropdown: {
      ...
      properties: {
        ...
        limit: {
          ...
          description: "Total number of rows expandable at a time.  Value of 0 allows unlimited.  (Set to disable dropdown to remove entirely)",
          default: 1,
          enum: [0, 1] // for now
        },
        component: {
    ...
    pagination: {
      ...
      properties: {
        ...
        padEmptyRows: {
          type: "boolean",
          default: true,
          description: "Whether to pad empty rows in a table with whitespace to maintain same size between pages (typically only applicable to last page)"
        },
      }
    },
    filtering: {
      ...
      properties: {
        ...
        limit: {
          title: "Total Expanded Row Limit",
          description: "Total number of rows expandable at a time.  Value of 0 allows unlimited.  (Set to disabled to remove entirely)",
          default: 1,
          enum: [0, 1] // for now
        }
      }
...
const RecordTableAction = {
  ...
  properties: {
    ...
    displayInvalid: {
      ...
      description: "How to handle invalid actions.  Display an error, disable it (greyed out), or hide the action button"
    },
    invalidError: {
      type: "string",
