...
export async function up(knex: Knex) {
  await knex.raw(
    ...
    `
      ...
      refresh materialized view invasivesbc.current_positive_observations_materialized;
      refresh materialized view invasivesbc.current_negative_observations_materialized;
