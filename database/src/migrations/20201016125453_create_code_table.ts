...
export async function up(knex: Knex): Promise<void> {
  return knex.schema.withSchema('invasivesbc')
  ...
  .createTable('code_header', function(table) {
    ...
    table
      .integer('code_category_id')
      .references('code_category_id')
      .inTable('invasivesbc.code_category')
  ...
  .createTable('code', function(table) {
    ...
    table
      .integer('code_header_id')
      .references('code_header_id')
      .inTable('invasivesbc.code_header')
...
export async function down(knex: Knex): Promise<void> {
  return knex.schema.withSchema('invasivesbc')
    .dropTable('code')
    .dropTable('code_header')
    .dropTable('code_category')
}
