      ...
      case jsonb_typeof(
        ...
        species_full_descriptions_by_activity_id as (
          ...
          from 
            ...
            left join species_positive_description_aggregated_by_activity_id sp on sp.activity_incoming_data_id = a.activity_incoming_data_id 
            left join species_negative_description_aggregated_by_activity_id sn on sn.activity_incoming_data_id = a.activity_incoming_data_id 
            left join species_treated_description_aggregated_by_activity_id st on st.activity_incoming_data_id = a.activity_incoming_data_id 
            left join species_biocontrol_description_aggregated_by_activity_id sb on sb.activity_incoming_data_id = a.activity_incoming_data_id 
          where 
            a.iscurrent 
