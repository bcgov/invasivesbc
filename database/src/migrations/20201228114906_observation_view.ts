...
export async function up(knex: Knex): Promise<void> {
  ...
  CREATE OR REPLACE VIEW observation_common_fields_view as (
    ...
    activity_payload::json->'form_data'->'activity_type_data'->'observer_last_name' as primary_user_last_name__NEEDS_VERIFY,
    activity_payload::json->'species' as species__NEEDS_VERIFY,
