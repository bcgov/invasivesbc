...
export async function up(knex: Knex) {
  const insertedHeader = await knex.raw(`
    INSERT INTO invasivesbc.code_header (code_category_id, code_header_name, code_header_title, code_header_description,
                                         ...
                                         updated_by_user_id)
    VALUES (2, 'watercraft_complexity', 'watercraft_complexity', 'Complexity of watercraft in blow-by',
  ...
  await knex.raw(`
    INSERT INTO invasivesbc.code(code_header_id, code_name, code_description, code_sort_order, created_by_user_id,
                                 updated_by_user_id)
    VALUES (${codeHeaderId}, 'WCBB-1', 'Non-motorized', 1, 1, 1);
    INSERT INTO invasivesbc.code(code_header_id, code_name, code_description, code_sort_order, created_by_user_id,
                                 updated_by_user_id)
    VALUES (${codeHeaderId}, 'WCBB-2', 'Simple', 2, 1, 1);
    INSERT INTO invasivesbc.code(code_header_id, code_name, code_description, code_sort_order, created_by_user_id,
                                 updated_by_user_id)
    VALUES (${codeHeaderId}, 'WCBB-3', 'Complex', 3, 1, 1);
    INSERT INTO invasivesbc.code(code_header_id, code_name, code_description, code_sort_order, created_by_user_id,
                                 updated_by_user_id)
    VALUES (${codeHeaderId}, 'WCBB-4', 'Very Complex', 4, 1, 1);
  `);
}
...
export async function down(knex: Knex) {
  const insertedHeader = await knex.raw(`
    ...
    WHERE code_header_name = 'watercraft_complexity';
  `);
