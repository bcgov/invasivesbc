   ...
   AS $function$
     ...
     from 
       ...
       left join jsonb_array_elements(
         ...
         where 
           activity_incoming_data_id = new.activity_incoming_data_id
           ), jurisdictions_description as ( 
     select activity_incoming_data_id,
       string_agg (
         ...
         from 
           ...
           and jurisdictions_array #>> '{jurisdiction_code}' = jurisdiction_codes.code_name
