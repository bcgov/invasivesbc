...
drop trigger if exists activity_deleted on activity_incoming_data; 
drop view if exists common_summary cascade; 
                        ...
                        jsonb_array_length(
                          ...
                          translate(
                            ...
                            jsonb_array_length(
                              ...
                              replace(
                                translate(
                                  a.activity_payload #>> '{form_data, activity_type_data, activity_persons}', '"[{}]:', '')::text, 'person_name ', '') AS treatment_person,
                                        ...
                                        select 
                                          ...
                                          not_tank_mix_plant_herbicide_join as (
                                            select 
                                              ...
                                              c.area_treated_hectares, 
                                              c.percentage_area_covered, 
                                            ...
                                            from 
                                              ...
                                              inner join calculation_array_select c on c.calculation_invasive_plant_id = i.invasive_plant_id
                                          ), 
                                          ...
                                          tank_mix_results_select as (
                                            ...
                                            from 
                                              ...
                                              inner join tank_mix_plant_results_select c on c.results_herbicide_plant_index = i.herbicide_plant_index
                                          ), 
                                          jurisdiction_array as (
                                            select 
                                              ...
                                              tank_mix_json_select as (
                                                ...
                                                from 
                                                  form_data f 
                                                  inner join tank_mix_results_select tm on tm.activity_incoming_data_id = f.activity_incoming_data_id 
                                                  left join jurisdiction_array_select j on j.activity_incoming_data_id = f.activity_incoming_data_id 
                                                  left join code_header chemical_method_code_header on chemical_method_code_header.code_header_title = 'chemical_method_code' 
                                                  and chemical_method_code_header.valid_to is null 
                                                  left join code chemical_method_codes on chemical_method_codes.code_header_id = chemical_method_code_header.code_header_id 
                                            ...
                                            SELECT 
                                              ...
                                              concat(tm.tank_mix, j.tank_mix) as tank_mix, 
                                              concat(
                                              ...
                                              concat(
                                                ...
                                                tm.amount_of_mix_used, j.amount_of_mix_used
            ...
            select 
              ...
              calculation_array as (
                select 
                  activity_incoming_data_id, 
                  activity_payload #>> '{form_data, activity_subtype_data, chemical_treatment_details, tank_mix}' as tank_mix,
                  activity_incoming_data.activity_payload #> '{form_data, activity_subtype_data, chemical_treatment_details, calculation_results}' as json_data,
                  jsonb_array_elements(
                    activity_incoming_data.activity_payload #> '{form_data, activity_subtype_data, chemical_treatment_details, calculation_results, invasive_plants}') as json_array
                    from 
                      activity_incoming_data 
                    where 
                      activity_incoming_data_id in (
                    ...
                    select 
                      ...
                      jsonb_array_elements(
                        ...
                        from 
                          calculation_array c 
                        where 
                          c.activity_incoming_data_id in (
                            select 
                              incoming_data_id 
                            from 
                              activity_current
                          ...
                          herbicide_select as (
                            select 
                              ...
                              calculation_select as (
                                select 
                                  c.activity_incoming_data_id, 
                                  c.json_data #>> '{dilution}' as dilution,
                                  c.json_data #>> '{area_treated_sqm}' as area_treated_sqm,
                                  c.json_data #>> '{percent_area_covered}' as percent_area_covered,
                                  c.json_data #>> '{area_treated_hectares}' as area_treated_hectares,
                                  c.json_data #>> '{amount_of_undiluted_herbicide_used_liters}' as amount_of_undiluted_herbicide_used_liters
                                from 
                                ...
                                where 
                                  ...
                                  and c.activity_payload #> '{form_data, activity_subtype_data, chemical_treatment_details, calculation_results, invasive_plants}' is null
                                  ), 
                              calculation_array_select as (
                                select 
                                  i.activity_incoming_data_id, 
                                        ...
                                        select 
                                          ...
                                          not_tank_mix_plant_herbicide_join as (
                                            select 
                                              ...
                                              h.herbicide_id, 
                                              concat(
                                                a.amount_of_mix_used, h.amount_of_mix
                                              ) as amount_of_mix_used, 
                                              concat(
                                                a.area_treated_sqm, c.area_treated_sqm
                                              ) as area_treated_sqm, 
                                              concat(
                                                a.area_treated_hectares, c.area_treated_hectares
                                              ) as area_treated_hectares, 
                                              concat(
                                                a.percentage_area_covered, c.percent_area_covered
                                              ) as percentage_area_covered, 
                                              concat(
                                                a.amount_of_undiluted_herbicide_used_liters, 
                                                c.amount_of_undiluted_herbicide_used_liters
                                              ) as amount_of_undiluted_herbicide_used_liters, 
                                              concat(a.dilution, c.dilution) as dilution 
                                            from 
                                              invasive_plant_array_select i 
                                              inner join herbicide_select h on h.activity_incoming_data_id = i.activity_incoming_data_id 
                                              left join calculation_select c on c.activity_incoming_data_id = i.activity_incoming_data_id 
                                              left join calculation_array_select a on a.calculation_invasive_plant_id = i.invasive_plant_id
                                          ), 
                                          tank_mix_plant_results_select as (
                                            select 
                                              h.activity_incoming_data_id, 
