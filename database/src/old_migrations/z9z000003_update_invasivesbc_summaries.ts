...
or replace view invasivesbc.biocontrol_collection_summary as (
  ...
  collection_array as (
    select 
      ...
      biocontrol ->> 'total_bio_agent_quantity_actual' as total_agent_quantity_actual,
      biocontrol ->> 'total_bio_agent_quantity_estimated' as total_agent_quantity_estimated
    from 
      activity_incoming_data, 
      ...
      collection_string_agg as (
        select 
          ...
          c.total_agent_quantity_estimated,
          string_agg (
            distinct c.actual_agent_stage_code, 
            ', ' 
            order by 
              c.actual_agent_stage_code
          ) actual_agent_stage, 
          ...
          string_agg (
            distinct c.estimated_agent_stage_code, 
            ', ' 
            order by 
              c.estimated_agent_stage_code
