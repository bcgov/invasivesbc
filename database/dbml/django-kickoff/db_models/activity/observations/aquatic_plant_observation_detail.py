...
from invasivesbc.db_models.codes import DensityCode, DistributionCode, AquaticPlantCode, PlantLifeStageCode
...
class AquaticPlantObservationDetail(BaseOneToManyActivityTable):
  ...
  class Meta:
    ...
    constraints = [
      models.UniqueConstraint(fields=["activity_id", "invasive_plant"], name="aquaticplant_observation_detail_unique_plant")
    ]
