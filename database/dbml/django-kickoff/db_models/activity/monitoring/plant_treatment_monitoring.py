...
from invasivesbc.db_models.codes import EfficacyManagementRatingCode, AquaticPlantCode, TerrestrialPlantCode, InvasivePlantsOnSiteCode
from invasivesbc.db_models.enums import YesNo, TreatmentPass
...
class PlantMonitoringBase(BaseOneToManyActivityTable):
  ...
  management_efficacy_rating = models.ForeignKey(EfficacyManagementRatingCode, on_delete=models.PROTECT)
  invasive_plants_on_site = models.ForeignKey(InvasivePlantsOnSiteCode, on_delete=models.PROTECT)
  ...
  class Meta:
    abstract=True
    constraints = [
      models.UniqueConstraint(fields=["activity_id", "invasive_plant"], name="u_mech_plant_monitoring")
    ]
