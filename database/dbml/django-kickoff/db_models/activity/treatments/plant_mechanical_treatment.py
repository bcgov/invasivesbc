...
from invasivesbc.db_models.codes import AquaticPlantCode, TerrestrialPlantCode, PlantMechanicalTreatmentMethodCode, DisposalMethodCode
from invasivesbc.db_models.enums import PlantDisposalFormat
...
class PlantMechanicalTreatment(BaseOneToManyActivityTable):
  ...
  mechanical_method = models.ForeignKey(PlantMechanicalTreatmentMethodCode, on_delete=models.PROTECT)
  ...
  class Meta:
    abstract=True
    constraints = [
      models.UniqueConstraint(fields=["activity_id", "invasive_plant"], name="uq_mechanical_plant_treat")
    ]
...
class TerrestrialPlantMechanicalTreatment(PlantMechanicalTreatment):
  ...
  class Meta:
    # db_table_comment="activity"."terrestrial_plant_mechanical_treatment"'
    pass
...
class AquaticPlantMechanicalTreatment(PlantMechanicalTreatment):
  ...
  class Meta:
    # db_table_comment="activity"."aquatic_plant_mechanical_treatment"'
    pass
