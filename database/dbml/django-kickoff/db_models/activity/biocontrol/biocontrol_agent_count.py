...
from invasivesbc.db_models.codes import BiocontrolAgentCode, BioAgentLifeStageCode, TerrestrialPlantCode, AgentLocationFoundCode, PlantPositionCode
...
class BiocontrolAgentCountSimple(BaseOneToManyActivityTable):
  ...
  class Meta:
    ...
    constraints = [
      models.UniqueConstraint(fields=["activity_id", "invasive_plant", "biocontrol_agent", "stage", 'is_estimate'], name="unique_simple_agent_count")
    ]
...
class BiocontrolAgentCountComplex(BiocontrolAgentCountSimple):
  ...
  class Meta:
    ...
    constraints = [
      models.UniqueConstraint(fields=["activity_id", "invasive_plant", "biocontrol_agent", "stage", 'is_estimate', "agent_location", "plant_location"], name="unique_complex_agent_count")
    ]
